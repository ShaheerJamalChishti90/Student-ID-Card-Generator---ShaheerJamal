...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
  ...
  // Sql query to be executed
  $sql = "INSERT INTO `cards`(`name`, `id_no`, `email`, `phone`, `address`, `course`, `dob`, `exp_date`, `image`) VALUES ('$name','$id_no','$email]','$phone','$address', '$course','$dob','$exp_date','$uploadfile')"; 
...
<link rel="icon" type="image/png" href="images/favicon.png"/>
  <title>Add New Student | Shaheer Jamal</title>
        ...
        <form method="POST">
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <input class="form-control" id="courseEdit" name="courseEdit"></input>
            </div> 
          </div>
...
<div class="collapse" id="collapseExample">
  <div class="card card-body">
    ...
    <div class="form-row">
      ...
      <div class="form-group col-md-4">
        ...
        <select name="grade" class="form-control">
          ...
          <option value="7th">8th</option>
          <option value="7th">9th</option>
    ...
    <div class="form-row">
      ...
      <div class="form-row">
        ...
        <div class="form-group col-md-3">
          <label for="course">Course.</label>
          <input class="form-control" id="course" name="course" ></input>
        </div>
        <div class="form-group col-md-4">
  ...
  <hr>
  <a href="https://github.com/ShaheerJamalChishti90" type="button" class="btn btn-primary btn-lg btn-block" target="_blank">Shaheer Jamal</a>
  <!-- Optional JavaScript -->
